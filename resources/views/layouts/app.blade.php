...
<body>
    ...
    <nav class="navbar navbar-custom sticky-top">
        <div class="container flex-nowrap">
            ...
            <div class="d-flex gap-1 gap-md-2 align-items-center flex-shrink-0">
                <a href="{{ route('antrian.daftar') }}" class="btn btn-sm btn-gradient rounded-pill px-2 px-md-3">
                    <i class="bi bi-person-plus me-1"></i> Daftar
                </a>
                @auth
                    <div class="dropdown">
                        <button class="btn btn-sm btn-gradient rounded-pill px-2 px-md-3 dropdown-toggle" type="button" data-bs-toggle="dropdown">
    ...
    <footer class="footer-custom">
        <div class="container">
            &copy; {{ date('Y') }} Sistem Antrian BPS Kota Tegal &mdash; Inovasi Cerdas untuk Kemudahan dan Kenyamanan Antrian Anda
        </div>
    </footer>
