        ...
        <form action="{{ route('antrian.simpan') }}" method="POST" id="formDaftar">
            ...
            <div class="mb-4">
                ...
                <div class="form-icon-wrapper">
                    ...
                    <input type="text" class="form-control @error('nik') is-invalid @enderror" name="nik" value="{{ old('nik') }}" placeholder="Masukkan 16 digit NIK" minlength="16" maxlength="16" required>
                </div>
                @error('nik')
            ...
            <div class="mb-4">
                ...
                <div class="form-icon-wrapper">
                    ...
                    <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" value="{{ old('nama') }}" placeholder="Masukkan nama lengkap Anda" required>
                </div>
                @error('nama')
                    <div class="text-danger mt-1" style="font-size: 0.8rem;">{{ $message }}</div>
                @enderror
            ...
            <div class="mb-4">
                ...
                <div class="form-icon-wrapper">
                    ...
                    <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="Contoh: nama@domain.com" required>
                </div>
                @error('email')
                    <div class="text-danger mt-1" style="font-size: 0.8rem;">{{ $message }}</div>
                @enderror
            ...
            <div class="mb-4">
                ...
                <div class="form-icon-wrapper">
                    ...
                    <input type="text" class="form-control @error('pekerjaan') is-invalid @enderror" name="pekerjaan" value="{{ old('pekerjaan') }}" placeholder="Masukkan pekerjaan Anda" required>
                </div>
                @error('pekerjaan')
                    <div class="text-danger mt-1" style="font-size: 0.8rem;">{{ $message }}</div>
                @enderror
            ...
            <div class="mb-4">
                ...
                <div class="form-icon-wrapper">
                    ...
                    <select class="form-select @error('pendidikan_terakhir') is-invalid @enderror" name="pendidikan_terakhir" required>
            ...
            <div class="mb-4">
                ...
                <div class="form-icon-wrapper">
                    ...
                    <textarea class="form-control @error('alamat') is-invalid @enderror" name="alamat" rows="2" placeholder="Alamat lengkap sesuai KTP" required style="height: auto;">{{ old('alamat') }}</textarea>
                </div>
                @error('alamat')
                    <div class="text-danger mt-1" style="font-size: 0.8rem;">{{ $message }}</div>
                @enderror
